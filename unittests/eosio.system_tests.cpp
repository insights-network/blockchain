...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, eosio_system_tester) try {
   ...
   // Initially, only producvotera stakes tokens.
   transfer(config::system_account_name, "producvotera", core_from_string("200000000.0000"), config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvotera", core_from_string("20000000.0000"), core_from_string("20000000.0000") ));
   BOOST_REQUIRE_EQUAL(success(), vote( N(producvotera), vector<account_name>(producer_names.begin(), producer_names.begin()+10)));
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, eosio_system_tester ) try {
   ...
   stake_with_transfer( config::system_account_name, "bob",  core_from_string( "8750000.0000" ), core_from_string( "8750000.0000" ) );
   stake_with_transfer( config::system_account_name, "carl", core_from_string( "8750000.0000" ), core_from_string( "8750000.0000" ) );
   ...
   // TODO unsure why this one is failing
